...
**/
if ( ! function_exists('page_menu_fallback')) {
	function page_menu_fallback(){ ?>
		<ul class="menu menu-fallback">
			<li><a href="/wp-admin/nav-menus.php" class="menu__link">Set A Menu</a></li>
			<li><a href="#" class="menu__link">Lorem ipsum</a></li>
			<li><a href="#" class="menu__link">Phasellus tincidunt</a></li>
			<!-- <li><a href="#" class="menu__link">Etiam molestie</a></li> -->
			<!-- <li><a href="#" class="menu__link">Nulla vestibulum</a></li> -->
		</ul>
	<?php }
}
...
/**
 * @package 	 	Mobile Nav menu walker
 * 
 * @author		 	Brett Shenk
 * @version		 	1.0.0
 * @license		 	none (public domain)
 * @copyright	 	2023
**/
if ( ! function_exists('mobile_menu_addon')) {
	function mobile_menu_addon(){
		return;
	}
}
class mobile_walker_texas_ranger extends Walker_Nav_Menu {
	/**
	 * Start the element output.
	 *
	 * @see Walker::start_el()
	...
	**/
	...
	public function prepare_el_classes( &$item, $args = array(), $depth = 0 ) {
		$block = isset( $args->block ) ? $args->block : explode(' ', $args->menu_class);
		$block = is_array( $block ) ? $block[0] : $block;
		$classes = array( $block . '__item', 'mobile' );
