...
function the_login_page(){
        ...
        if ( $_POST['token'] == $_SESSION['token'] ){
             ...
             */
                ...
                if ( is_wp_error($user_verify) ){ 
                    ...
                    // Success message
                    echo "<script type='text/javascript'>window.location.href='". esc_url( home_url('/my-account/') ) ."'</script>";
                    exit();
                }
            }
    ...
    <form name="login" action="<?php echo esc_url( home_url('/login/') ); ?>" method="post" class="account-form-wrapper background">
        <h2>Login</h2>
